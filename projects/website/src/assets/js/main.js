    ...
    "use strict";
        ...
        if (null !== t) {
            ...
            new Chart(a, {
                ...
                options: {
                    ...
                    responsive: !0,
                    scales: {
                        xAxes: [{ticks: {fontColor: "#8d9cab"}, gridLines: {color: "#cfd8df"}}],
                        yAxes: [{gridLines: {color: "#cfd8df"}, ticks: {beginAtZero: !0, fontColor: "8d9cab"}}]
                    }
                }
            })
        }
        ...
        "function" == typeof e.isotope && e.each(function () {
            ...
            t.isotope({
                ...
                return void 0 !== e ? (t.isotope({filter: e}), t.isotope().one("arrangeComplete", function () {
        ...
        i.length && i.hasClass("js-fixed-footer") && (i.before('<div class="block-footer-height"></div>'), o(".block-footer-height").matchHeight({target: i}))
    },
        ...
        o('#map-tabs a[data-toggle="tab"]').on("shown.bs.tab", function (e) {
            ...
            var t = o(e.target).attr("href"), a = o(".tab-pane" + t);
          ...
          CRUMINA.initSmoothScroll(), (o(".js-popup-iframe").length || o(".js-zoom-image").length) && CRUMINA.mediaPopups(),
        o(".crumina--select").length && CRUMINA.select2Init(), o(".header--sticky").length && CRUMINA.fixedHeader()
    })
}(jQuery)
