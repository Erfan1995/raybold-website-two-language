...
class UserController extends Controller
{
    ...
    private function editUsers(array $data)
    {
        ...
        $users->user_status_id = $data['user_status_id'];
        $users->privilege_id = $data['privilege_id'];
        return $users->save();
    }
    ...
    public function authenticate(Request $request)
    {
        ...
        try {
            $data = User::select('users.id as user_id', 'slug', 'email', 'full_name', 'user_status.status')
